...
/**
 * Hero Image Rotation - Display random images every 3 seconds
 */
let heroImageInterval = null;

// List of all available images for hero rotation
const heroImages = [
    'Asset/IMG_7102.jpg',
    'Asset/IMG_7103.jpg',
    'Asset/IMG_7104.jpg',
...
function initHeroImageRotation() {
    ...
    heroImageInterval = setInterval(changeHeroImage, 3000);
